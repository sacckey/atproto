...
COMPOSE_URL="https://raw.githubusercontent.com/sacckey/atproto/pds/pds/compose.yaml"
...
JWT_SECRET=$(eval "${GENERATE_SECURE_SECRET_CMD}")
ADMIN_PASSWORD=${PDS_ADMIN_PASSWORD}

PORT=3000
PLC_ROTATION_KEY=$(eval "${GENERATE_K256_PRIVATE_KEY_CMD}")
REPO_SIGNING_KEY=$(eval "${GENERATE_K256_PRIVATE_KEY_CMD}")
RECOVERY_KEY="did:plc:$(eval "${GENERATE_K256_PRIVATE_KEY_CMD}")"

DB_CREDS_JSON='{"username":"postgres","password":"password","host":"db","port":"5432"}'
DB_MIGRATE_CREDS_JSON='{"username":"postgres","password":"password","host":"db","port":"5432"}'
DB_SCHEMA=postgres
...
SMTP_HOST=${PDS_HOSTNAME}
SMTP_USERNAME=user
SMTP_PASSWORD=password

S3_BUCKET_NAME=s3_bucket_name
BLOBSTORE_LOC=/pds/blob/image
BLOBSTORE_TMP=/pds/blob/tmp
BLOB_CACHE_LOC=/pds/blob/chache

PUBLIC_URL="https://${PDS_HOSTNAME}"
# CF_DISTRIBUTION_ID=
# FEED_PUBLISHER_DID=
